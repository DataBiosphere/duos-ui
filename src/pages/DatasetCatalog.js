                      ...
                      return h(Fragment, { key: trIndex }, [
                        ...
                        tr({ className: 'tableRow' }, [
                          ...
                          td({
                            ...
                            className: 'catalog-table-items cell-size ' + (!dataSet.active ? 'dataset-disabled' : '')
                          }, [dataSet.alias]),
                          ...
                          td({ className: 'catalog-table-items cell-size ' + (!dataSet.active ? 'dataset-disabled' : '') },
                            [dataSet.dbGapLink !== '' ?
                              a({
                          ...
                          td({ id: trIndex + '_pi', name: 'pi', className: 'catalog-table-items cell-size ' + (!dataSet.active ? 'dataset-disabled' : '') }, [
                          ...
                          td({
                            id: trIndex + '_scid', name: 'sc-id', className: 'catalog-table-items cell-size ' + (!dataSet.active ? 'dataset-disabled' : '')
                          }, [
                            this.defaultString(
                          ...
                          td({ isRendered: this.state.isAdmin, className: 'catalog-table-items cell-size' }, [
                            a({
