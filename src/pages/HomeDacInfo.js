      ...
      div({className: 'row'}, [
        div({className: 'col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-sm-12 col-xs-12'}, [
          ...
          div({style: sectionWrapper}, [
            ...
            div({style: sectionWrapper}, [
              h3({style: faqTitle}, ['Can my DAC use DUOS?']),
              div({style: sectionBody}, [
            ...
            div({style: sectionWrapper}, [
              h3({style: faqTitle}, ['If my DAC wants to use DUOS, does my data have to be in a specific system?']),
              div({style: sectionBody}, [
            ...
            div({style: sectionWrapper}, [
              h3({style: faqTitle}, ['How do I determine the data use limitations for my dataset(s)?']),
              div({style: sectionBody}, [
            ...
            div({style: sectionWrapper}, [
              h3({style: faqTitle}, ['Does DUOS store genetic data?']),
              div({style: sectionBody}, [
            ...
            div({style: sectionWrapper}, [
              h3({style: faqTitle}, ['If I make my data available via DUOS, does it need to be located in a single location?']),
              div({style: sectionBody}, [
            ...
            div({style: sectionWrapper}, [
              h3({style: faqTitle}, ['Can DUOS allow for multiple parties to review and approve a data access request?']),
              div({style: sectionBody}, [
            ...
            div({style: sectionWrapper}, [
              h3({style: faqTitle}, ['Does DUOS automate data access requests?']),
              div({style: sectionBody}, [
