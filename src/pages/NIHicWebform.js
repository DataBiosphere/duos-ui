        ...
        <div id='form-views'>
          <div className='col-lg-10 col-lg-offset-1 col-xs-12'>
            <fieldset>
              ...
              <div className='form-group'>
                <div className='col-xs-12 rp-group'>
                  <label className='control-label rp-title-question common-color'>Assistant/Submitter Name (if applicable)</label>
                </div>
                <div className='col-xs-12 rp-group rp-last-group'>
                  <input
                    type='text'
              ...
              <div className='form-group'>
                <div className='col-xs-12 rp-group'>
                  <label className='control-label rp-title-question common-color'>Assistant Submitter Email</label>
                </div>
                <div className='col-xs-12 rp-group rp-last-group'>
                  <input
                    type='text'
              ...
              <div className='form-group' style={{ color: Theme.palette.primary }}>
                <div className='col-xs-12 rp-group'>
                  <label className='control-label rp-title-question common-color'>NIH Institutes/Centers supporting the study</label>
                </div>
                <div className='col-xs-12 rp-group'>
                  <div className='checkbox'>
                    <input id='nhgri' type='checkbox' />
                    <label className='regular-checkbox rp-choice-questions' htmlFor='nhgri'>
                      <span style={{ color: Theme.palette.primary }}>NHGRI</span>
                    </label>
                  </div>
                </div>
                ...
                <div className='col-xs-12 rp-group'>
                  <div className='checkbox'>
                    <input id='nci' type='checkbox' />
                    <label className='regular-checkbox rp-choice-questions' htmlFor='nci'>
                      <span style={{ color: Theme.palette.primary }}>NCI</span>
                    </label>
                  </div>
                </div>
                <div className='col-xs-12 rp-group'>
                  <div className='checkbox'>
                    <input id='nhlbi' type='checkbox' />
                    <label className='regular-checkbox rp-choice-questions' htmlFor='nhlbi'>
                      <span style={{ color: Theme.palette.primary }}>NHLBI</span>
                    </label>
                  </div>
                </div>
                <div className='col-xs-12 rp-group'>
                  <div className='checkbox'>
                    <input id='nimh' type='checkbox' />
                    <label className='regular-checkbox rp-choice-questions' htmlFor='nimh'>
                      <span style={{ color: Theme.palette.primary }}>NIMH</span>
                    </label>
                  </div>
                </div>
                <div className='col-xs-12 rp-group'>
                  <div className='checkbox'>
                    <input id='nidcr' type='checkbox' />
                    <label className='regular-checkbox rp-choice-questions' htmlFor='nidcr'>
                      <span style={{ color: Theme.palette.primary }}>NIDCR</span>
                    </label>
                  </div>
                </div>
                <div className='col-xs-12 rp-group'>
                  <div className='checkbox'>
                    <input id='niaid' type='checkbox' />
                    <label className='regular-checkbox rp-choice-questions' htmlFor='niaid'>
                      <span style={{ color: Theme.palette.primary }}>NIAID</span>
                    </label>
                  </div>
                </div>
                <div className='col-xs-12 rp-group'>
                  <div className='checkbox'>
                    <input id='ninds' type='checkbox' />
                    <label className='regular-checkbox rp-choice-questions' htmlFor='ninds'>
                      <span style={{ color: Theme.palette.primary }}>NINDS</span>
                    </label>
                  </div>
                </div>
                <div className='col-xs-12 rp-group'>
                  <div className='checkbox'>
                    <input id='ncats' type='checkbox' />
                    <label className='regular-checkbox rp-choice-questions' htmlFor='ncats'>
                      <span style={{ color: Theme.palette.primary }}>NCATS</span>
                    </label>
                  </div>
                </div>
                <div className='col-xs-12 rp-group'>
                  <div className='checkbox'>
                    <input id='nia' type='checkbox' />
                    <label className='regular-checkbox rp-choice-questions' htmlFor='nia'>
                      <span style={{ color: Theme.palette.primary }}>NIA</span>
                    </label>
                  </div>
                </div>
                <div className='col-xs-12 rp-group'>
                  <div className='checkbox'>
                    <input id='niddk' type='checkbox' />
                    <label className='regular-checkbox rp-choice-questions' htmlFor='niddk'>
                      <span style={{ color: Theme.palette.primary }}>NIDDK</span>
                    </label>
                  </div>
                </div>
                <div className='col-xs-12 rp-group'>
                  <div className='checkbox'>
                    <input id='nei' type='checkbox' />
                    <label className='regular-checkbox rp-choice-questions' htmlFor='nei'>
                      <span style={{ color: Theme.palette.primary }}>NEI</span>
                    </label>
                  </div>
                </div>
                <div className='col-xs-12 rp-group'>
                  <div className='checkbox'>
                    <input id='nida' type='checkbox' />
                    <label className='regular-checkbox rp-choice-questions' htmlFor='nida'>
                      <span style={{ color: Theme.palette.primary }}>NIDA</span>
                    </label>
                  </div>
                </div>
              </div>
              ...
              <div className='form-group'>
                <div className='col-xs-12 rp-group'>
                  <label className='control-label rp-title-question common-color'>NIH Program Officer Name</label>
                </div>
                <div className='col-xs-12 rp-group'>
                  <Select
              ...
              <div className='form-group'>
                <div className='col-xs-12 rp-group'>
                  <label className='control-label rp-title-question common-color'>NIH Institute/Center for Submission</label>
                </div>
                <div className='col-xs-12 rp-group'>
                  <Select
              ...
              <div className='form-group'>
                <div className='col-xs-12 rp-group'>
                  <label className='control-label rp-title-question common-color'>NIH Genomic Program Administrator Name</label>
                </div>
                <div className='col-xs-12 rp-group'>
                  <Select
            ...
            <div className='form-group'>
              <div className='col-xs-12 rp-group'>
                <label className='control-label rp-title-question common-color'>Original Study Name</label>
              </div>
              <div className='col-xs-12 rp-group rp-last-group'>
                <input
                  type='text'
            ...
            <div className='form-group'>
              <div className='col-xs-12 rp-group'>
                <label className='control-label rp-title-question common-color'>Study Type</label>
              </div>
              <div className='col-xs-12 rp-group'>
                <Select
                  name='studyType'
            ...
            <div className='form-group'>
              <div className='col-xs-12 rp-group'>
                <label className='control-label rp-title-question common-color'>Project Title (for data to be submitted)</label>
              </div>
              <div className='col-xs-12 rp-group rp-last-group'>
                <input
                  type='text'
            ...
            <div className='form-group'>
              <div className='col-xs-12 rp-group'>
                <label className='control-label rp-title-question common-color'>Is this a multi-center study?</label>
              </div>
              <div className='row no-margin'>
            ...
            <div className='form-group'>
              <div className='col-xs-12 rp-group'>
                <label className='control-label rp-title-question common-color'>List Collaborating Sites (please enter a comma or tab delimited list)</label>
              </div>
              <div className='col-xs-12 rp-group rp-last-group'>
                <input
                  type='text'
            ...
            <div className='form-group'>
              <div className='col-xs-12 rp-group'>
                <label className='control-label rp-title-question common-color'>The individual level data are to be made available through:</label>
              </div>
              <div className='row no-margin'>
                <div className='col-xs-12 dataset-group'>
                  <RadioButton
            ...
            <div className='form-group'>
              <div className='col-xs-12 rp-group'>
                <label className='control-label rp-title-question common-color'>The genomic summary results (GSR) from this study are only to be made available through controlled-access</label>
              </div>
              <div className='row no-margin'>
                <div className='col-xs-12 dataset-group'>
                  <RadioButton
            ...
            <div style={{ marginBottom: '15px' }}>
              <div className='col-xs-12 rp-group'>
                <label className='control-label rp-title-question common-color'>Explanation if controlled-access for GSR was selected</label>
              </div>
            ...
            <div style={{ backgroundColor: Theme.palette.background.secondary, borderRadius: '9px' }}>
              <div className='col-xs-12 rp-group'>
                <label className='control-label rp-title-question common-color'>Consent Group - Name:</label>
              </div>
              <div className='col-xs-12 rp-group rp-last-group'>
                <input
                  type='text'
              ...
              <div className='col-xs-12 rp-group'>
                <span className='control-label rp-title-question common-color'>
                  ...
                  <span>Please select one of the following data use permissions for your dataset.</span>
                </span>
                <div className='row'>
                  <div className='col-xs-12 rp-group'>
              ...
              <div className='form-group'>
                <div className='col-xs-12 rp-group'>
                  <label className='control-label rp-title-question common-color'>Consent Group - Secondary Data Use Terms <span>Please select all applicable data use parameters.</span></label>
                </div>
              </div>
              <div className='col-xs-12 rp-group'>
                <div className='checkbox'>
                  ...
                  <label className='regular-checkbox rp-choice-questions' htmlFor='checkMethods'>
                    <span style={{ color: Theme.palette.primary }}>No methods development or validation studies (NMDS)</span>
                  </label>
                </div>
              </div>
              <div className='col-xs-12 rp-group'>
                <div className='checkbox'>
                  ...
                  <label className='regular-checkbox rp-choice-questions' htmlFor='checkGenetic'>
                    <span style={{ color: Theme.palette.primary }}>Genetic Studies Only (GSO)</span>
                  </label>
                </div>
              </div>
              <div className='col-xs-12 rp-group'>
                <div className='checkbox'>
                  ...
                  <label className='regular-checkbox rp-choice-questions' htmlFor='checkPublication'>
                    <span style={{ color: Theme.palette.primary }}>Publication Required (PUB)</span>
                  </label>
                </div>
              </div>
              <div className='col-xs-12 rp-group'>
              ...
              <div className='col-xs-12 rp-group'>
                <div className='checkbox'>
                  ...
                  <label className='regular-checkbox rp-choice-questions' htmlFor='checkEthics'>
                    <span style={{ color: Theme.palette.primary }}>Ethics Approval Required (IRB)</span>
                  </label>
                </div>
              </div>
              <div className='col-xs-12 rp-group'>
                <div className='checkbox'>
                  ...
                  <label className='regular-checkbox rp-choice-questions' htmlFor='checkGeographic'>
                    <span style={{ color: Theme.palette.primary }}>Geographic Restriction (GS-)</span>
                  </label>
                </div>
              </div>
              <div className='col-xs-12 rp-group'>
                <div className='checkbox'>
                  ...
                  <label className='regular-checkbox rp-choice-questions' htmlFor='checkMoratorium'>
                    <span style={{ color: Theme.palette.primary }}>Publication Moratorium (MOR)</span>
                  </label>
                </div>
              </div>
              <div className='col-xs-12 rp-group'>
                <div className='checkbox'>
                  ...
                  <label className='regular-checkbox rp-choice-questions' htmlFor='checkNpoa'>
                    <span style={{ color: Theme.palette.primary }}>No Populations Origins or Ancestry Research (NPOA)</span>
                  </label>
                </div>
              </div>
              <div className='col-xs-12 rp-group'>
                <div className='checkbox'>
                  ...
                  />
                  <label className='regular-checkbox rp-choice-questions' htmlFor='checkForProfit'>
                    <span style={{ color: Theme.palette.primary }}>Non-Profit Use Only (NPU)</span>
                  </label>
                </div>
              </div>
              <div className='col-xs-12 rp-group'>
                <div className='checkbox'>
                  ...
                  />
                  <label className='regular-checkbox rp-choice-questions' htmlFor='checkOtherSecondary'>
                    <span style={{ color: Theme.palette.primary }}>Other Secondary Use Terms:</span>
                  </label>
                </div>
              </div>
              <div className='col-xs-12 rp-group'>
              ...
              <div className='row no-margin'>
                <div className='col-xs-12'>
                  <a id='btn_addConsent' onClick={() => createConsent()} className='f-right btn-primary bold'>Add Consent Group</a>
                </div>
              </div>
            </div>
            ...
            <div style={{ backgroundColor: Theme.palette.background.secondary, borderRadius: '9px', margin: '15px 0' }}>
              {consentGroups.map((group, index) => (
                <div key={'consent_group_id' + index} style={{ padding: '10px', margin: '15px', color: Theme.palette.primary }}>
                  <div key='group_id' style={{ fontSize: '18px', padding: '10px 0', fontWeight: 500 }}>Consent Group {index + 1}</div>
                  <div style={{ display: 'flex', fontSize: '16px' }}>
                    <div key='name_label' style={{ fontWeight: 500, marginRight: '5px' }}>Name: </div>
                    <div key='name_value'>{group.name}</div>
                  </div>
                  <div style={{ display: 'flex', fontSize: '16px' }}>
                    <div key='primary_label' style={{ fontWeight: 500, marginRight: '5px' }}>Primary Use: </div>
                    <div key='primary_value'>{group.primaryUse}</div>
                  </div>
                  <div style={{ display: 'flex', fontSize: '16px' }}>
                    <div key='secondary_label' style={{ fontWeight: 500, marginRight: '5px' }}>Secondary Use: </div>
                    <div key='secondary_value'>{group.secondaryUse}</div>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className='form-group'>
              ...
              <div className='col-xs-12 rp-group'>
                <div className='checkbox'>
                  <input id='legal_restrictions' type='checkbox' />
                  <label className='regular-checkbox rp-choice-questions' htmlFor='legal_restrictions'>
                    <span style={{ color: Theme.palette.primary }}>Legal Restrictions</span>
                  </label>
                </div>
              </div>
              <div className='col-xs-12 rp-group'>
                <div className='checkbox'>
                  <input id='informed_consent' type='checkbox' />
                  <label className='regular-checkbox rp-choice-questions' htmlFor='informed_consent'>
                    <span style={{ color: Theme.palette.primary }}>Informed consent processes are inadequate to support data sharing for the following reasons:</span>
                  </label>
                </div>
              </div>
              <div className='col-xs-12 rp-group'>
                <div className='checkbox'>
                  ...
                  <label className='regular-checkbox rp-choice-questions' htmlFor='unavailable'>
                    <span style={{ color: Theme.palette.primary }}>The consent forms are unavailable or non-existent for samples collected after January 25, 2015</span>
                  </label>
                </div>
              </div>
              <div className='col-xs-12 rp-group'>
                <div className='checkbox'>
                  <input id='future_use' type='checkbox' />
                  <label className='regular-checkbox rp-choice-questions' htmlFor='future_use'>
                    <span style={{ color: Theme.palette.primary }}> The consent process did not explicitly address future use or broad data sharing for samples collect after January 25, 2015</span>
                  </label>
                </div>
              </div>
              <div className='col-xs-12 rp-group'>
                <div className='checkbox'>
                  <input id='risks' type='checkbox' />
                  <label className='regular-checkbox rp-choice-questions' htmlFor='risks'>
                    <span style={{ color: Theme.palette.primary }}>The consent process inadequately address risks related to future use or broad data sharing for samples collected after January 25, 2015</span>
                  </label>
                </div>
              </div>
              <div className='col-xs-12 rp-group'>
                <div className='checkbox'>
                  <input id='original_use_only' type='checkbox' />
                  <label className='regular-checkbox rp-choice-questions' htmlFor='original_use_only'>
                    <span style={{ color: Theme.palette.primary }}>The consent process specifically precludes future use or broad sharing (including a statement that use of data will be limited to the original researchers)</span>
                  </label>
                </div>
              </div>
              <div className='col-xs-12 rp-group'>
                <div className='checkbox'>
                  <input id='limitations' type='checkbox' />
                  <label className='regular-checkbox rp-choice-questions' htmlFor='limitations'>
                    <span style={{ color: Theme.palette.primary }}>Other informed consent limitations or concerns</span>
                  </label>
                </div>
              </div>
              <div className='col-xs-12 rp-group'>
                <div className='checkbox'>
                  <input id='other_reason' type='checkbox' />
                  <label className='regular-checkbox rp-choice-questions' htmlFor='other_reason'>
                    <span style={{ color: Theme.palette.primary }}>Other</span>
                  </label>
                </div>
              </div>
            </div>
            ...
            <div className='form-group'>
              ...
              <div className='col-xs-12 rp-group'>
                <div className='checkbox'>
                  <input id='species' type='checkbox' />
                  <label className='regular-checkbox rp-choice-questions' htmlFor='species'>
                    <span style={{ color: Theme.palette.primary }}>Species</span>
                  </label>
                </div>
              </div>
              ...
              <div className='col-xs-12 rp-group'>
                <div className='checkbox'>
                  <input id='sample_collection' type='checkbox' />
                  <label className='regular-checkbox rp-choice-questions' htmlFor='sample_collection'>
                    <span style={{ color: Theme.palette.primary }}>Sample Collection</span>
                  </label>
                </div>
              </div>
              <div className='col-xs-12 rp-group'>
                <div className='checkbox'>
                  ...
                  <label className='regular-checkbox rp-choice-questions' htmlFor='phenotype'>
                    <span style={{ color: Theme.palette.primary }}>Phenotype</span>
                  </label>
                </div>
              </div>
              <div className='col-xs-12 rp-group'>
                <div className='checkbox'>
                  <input id='genotype' type='checkbox' />
                  <label className='regular-checkbox rp-choice-questions' htmlFor='genotype'>
                    <span style={{ color: Theme.palette.primary }}>Genotypes</span>
                  </label>
                </div>
              </div>
              <div className='col-xs-12 rp-group'>
                <div className='checkbox'>
                  ...
                  <label className='regular-checkbox rp-choice-questions' htmlFor='general'>
                    <span style={{ color: Theme.palette.primary }}>General</span>
                  </label>
                </div>
              </div>
              <div className='col-xs-12 rp-group'>
                <div className='checkbox'>
                  <input id='sequencing' type='checkbox' />
                  <label className='regular-checkbox rp-choice-questions' htmlFor='sequencing'>
                    <span style={{ color: Theme.palette.primary }}>Sequencing</span>
                  </label>
                </div>
              </div>
              <div className='col-xs-12 rp-group'>
                <div className='checkbox'>
                  <input id='sample_types' type='checkbox' />
                  <label className='regular-checkbox rp-choice-questions' htmlFor='sample_types'>
                    <span style={{ color: Theme.palette.primary }}>Sample Types</span>
                  </label>
                </div>
              </div>
              <div className='col-xs-12 rp-group'>
                <div className='checkbox'>
                  ...
                  <label className='regular-checkbox rp-choice-questions' htmlFor='analyses'>
                    <span style={{ color: Theme.palette.primary }}>Analyses</span>
                  </label>
                </div>
              </div>
              <div className='col-xs-12 rp-group'>
                <div className='checkbox'>
                  <input id='array_data' type='checkbox' />
                  <label className='regular-checkbox rp-choice-questions' htmlFor='array_data'>
                    <span style={{ color: Theme.palette.primary }}>Array Data</span>
                  </label>
                </div>
              </div>
            </div>
            ...
            <div className='form-group'>
              ...
              <div className='row no-margin'>
                <div className='col-xs-12'>
                  <a id='btn_submit' className='f-right btn-primary dataset-background bold'>
