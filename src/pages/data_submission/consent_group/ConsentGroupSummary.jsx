      ...
      <div id={id} style={{ display: 'flex', justifyContent: 'space-around', margin: '1.5rem 0 1.5rem 0' }}>
        ...
        <div style={{ flex: '1 1 100%' }}>
          ...
          <div style={{ marginTop: '2px' }}>
            # of Participants:
            <span style={{ fontStyle: 'italic' }}>{consentGroup.numberOfParticipants}</span>
          </div>
          ...
          <div>
            {consentGroup.fileTypes.map((ft, idx) => (
              <div key={idx} style={{ marginBottom: '20px' }}>
                <div>
                  File Type:
                  <span style={{ fontStyle: 'italic' }}>{ft.fileType}</span>
                </div>
                <div>
                  Functional Equivalence:
                  <span style={{ fontStyle: 'italic' }}>{ft.functionalEquivalence}</span>
                </div>
              </div>
            ))}
          </div>
