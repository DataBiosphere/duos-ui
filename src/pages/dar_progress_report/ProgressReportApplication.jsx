...
import { get, head, isNil, keys, map } from 'lodash/fp';
import '../dar_application/DataAccessRequestApplication.css';
...
const ProgressReportApplication = (props) => {
    ...
    const init = useCallback(async () => {
        ...
        if (!isNil(collectionId)) {
            ...
            formData = Storage.getData('progress_report') === null ? formData : Storage.getData('progress_report');
            Storage.removeData('progress_report');
        }
                ...
                <div className='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                    <div className='row no-margin'>
                        ...
                        <div
                            ...
                            <PageHeading
                                title={formData.darCode}
                                description={props.readOnlyMode ? '' : formData.projectTitle}
                            />
                        </div>
                ...
                <form name='form' noValidate={true} className='forms-v2'>
                    ...
                    <div id='form-views'>
                        <ConfirmationDialog
                            ...
                            showModal={showDialogSave} action={{ label: 'Yes', handler: () => {} }}
                        >
                        ...
                        <ConfirmationDialog
                            ...
                            showModal={showDialogSubmit} action={{ label: 'Yes', handler: () => {} }}
                        >
                            <div className='dialog-description'>
                        ...
                        <div className='dar-steps'>
                            <div className='step-container'>
                                <div>Progress Report 1</div>
                            </div>

                            <div className='step-container'>
                                <div>Previous DAR Summary</div>
                            </div>
                        </div>
                    </div>
                </form>
...
export default ProgressReportApplication;
