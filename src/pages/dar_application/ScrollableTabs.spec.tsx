...
describe('ScrollableTabs Component - Tests', () => {
    ...
    mount(
      <BrowserRouter>
        <div style={{ display: 'inline-flex' }}>
          <ScrollableTabs applicationTabs={ApplicationTabs} formSelectedTabId="data-access-request" />
          <div>
  ...
  it('Case 1 - change tabs based on formSelectedTabId', () => {
    mount(<BrowserRouter><ScrollableTabs applicationTabs={ApplicationTabs} formSelectedTabId="data-access-request" /></BrowserRouter>)
    ...
    mount(<BrowserRouter><ScrollableTabs applicationTabs={ApplicationTabs} formSelectedTabId="research-purpose-statement" /></BrowserRouter>)
