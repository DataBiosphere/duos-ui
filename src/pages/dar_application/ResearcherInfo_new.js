      ...
      div({ className: 'dar-step-card' }, [
        ...
        div({className: 'dar-application-row'}, [
          h(FormField, {
            ...
            onChange: ({key, value}) => {
              formFieldChange({key, value: value});
            },
          ...
          div({className: 'row no-margin'}, [
            ...
            div({className: 'col-lg-12 col-md-12 col-sm-12 col-xs-12 rp-group'}, [
              h(CollaboratorList, {
                ...
                deleteBoolArray: (new Array(formData.internalCollaborators.length).fill(false)),
                showApproval: false})
            ])
          ])
        ]),
          ...
          div({ className: 'row no-margin' }, [
            ...
            div({ className: 'col-lg-12 col-md-12 col-sm-12 col-xs-12 rp-group' }, [
              h(CollaboratorList, {
                ...
                deleteBoolArray: (new Array(formData.externalCollaborators.length).fill(false)),
                showApproval: false
              })
            ])
          ])
