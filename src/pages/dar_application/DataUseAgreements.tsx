    ...
    <div className="dar-step-card" data-cy="data-use-agreements">
      ...
      <div className="form-group">
        ...
        <ol className="data-use-list">
          ...
          <li>
            Adhere to the NIH Security Best Practices for Controlled-Access Data Subject to the NIH Genomic Data
      ...
      <div>
        ...
        researcher. This does
        {' '}
        <span style={{ fontWeight: 600 }}>not</span>
        {' '}
        include lab technicians or trainees, e.g.,
