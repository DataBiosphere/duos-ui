            ...
            div({}, [
                div({ className: "container" }, [
                    ...
                    div({ className: "row fsi-row-lg-level fsi-row-md-level title-wrapper" }, [
                        img({ src: "/images/icon_statistics.png", alt: "Statistics icon", className: "cm-icons main-icon-title" }),
                        h2({ className: "main-title margin-sm common-color" }, [
                            "Votes statistics",
                            div({ className: "main-title-description" },
                                [
                                    "Summary statistics on the Data Access Committee and votes system"
                                ]),
                        ]),
                    ]),
