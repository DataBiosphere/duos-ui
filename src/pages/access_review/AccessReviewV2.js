      ...
      [
        ...
        div({ id: 'body', style: { display: 'flex' } }, [
          div(
            ...
            [DacVotePanel({ isUserChairForDataset, memberVotes, chairVotes, finalVotes, darId, accessElection, rpElection, consent, voteAsChair, selectChair: this.selectChair, updateVote: this.updateVote })]
          ),
          div(
            {
              id: 'application',
