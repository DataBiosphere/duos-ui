...
## Information DUOS May Collect From You
1. Our primary goals in collecting information are to provide genomic information management and analysis services to you, to improve our Site, features, content, and to run our business.
    1. Genomic Information That You Voluntarily Provide
        * DUOS collects and stores the genomic sequence data (DNA, RNA, etc), derived from humans or other organisms, that you submit to the Site along with metadata and other information related to such sequence data. You agree to and accept full responsibility for obtaining all necessary permissions and informed consents from the donors of all samples from which your submitted sequence data is derived.
    2. HIPAA, Protected Health Information, and the Clinical Compliance Features
        * DUOS is not a Covered Entity as that term is defined in the Health Insurance Portability and Accountability Act of 1996, as amended, and its related regulations (collectively, "HIPAA"). On occasion, DUOS may agree in writing with a user to perform services for the user in the storing PHI. We recommend that such users enter into a formal agreement with DUOS/Firecloud.
        * DUOS does offers clinical compliance features as part of its service ("Compliance Features") for users who wish to upload, store, or otherwise transfer PHI, as well as users who are using the Site in connection with their clinical operations. Users who desire to upload, store, or otherwise transfer PHI using the Site must implement all of the required Clinical Features and must enter a formal agreement with Firecloud stating that. The uploading, storing, or transferring of PHI using the Site by users that have not implemented the Clinical Features is strictly prohibited. You agree that, unless you have implemented the Clinical Features, you will not upload, store, or otherwise transfer PHI using the Site.
        * You acknowledge that this may require you, in some instances, to anonymize sequence data prior to uploading it to the Site. You further agree to indemnify and hold harmless DUOS of and from any and all claims, demands, losses, causes of action, damage, lawsuits, judgments, including attorneys' fees and costs, arising out of or relating to your uploading, storing, or transferring of PHI without having fully implemented the Clinical Features.
...
3. With Whom May DUOS Share Your Information?
    1. Service Providers
...
4. Information You Share With Other Users; Forums
    1. Our Site allows you to share the sequence data, reference genomes, and other information you submit to the Site with other users of the Site and third parties who are not users of the Site. DUOS is not responsible for such other users' and third parties' use of your sequence data, reference genomes or other information. You understand and acknowledge that, if you choose to share the sequence data, reference genomes, or other information you submit to the Site with other users of the Site or third parties, such shared information might be copied or redistributed by other users and third parties. Even after you remove information from your account or delete your account, copies of that information may remain viewable elsewhere to the extent it has previously been shared with others.
5. Links and Third Party Applications
    1. On the Site, we may provide links to websites or applications maintained by third parties, which we believe you may find useful. DUOS is not responsible for the privacy practices of these other websites or applications and we encourage you to review the privacy policies of each of those other websites or applications before using such websites and applications. If you click on these third-party links, these other websites or applications may place their own cookies or other files on your computer, collect data, or solicit Personal Information from you. Other websites and applications will have different policies and rules regarding the use or disclosure of the personal information you submit to them. We make no representation with regard to the policies or business practices of any websites or applications to which you connect through a link from this Site, and are not responsible for any material contained on, or any transactions that occur between you and any such website or application.
6. Location
...
7. General Data Privacy Regulation (GDPR)
    1. DUOS is compliant with the GDPR regulations as it becomes effective starting 25 May 2018. In the language of GDPR, DUOS positions itself as a Data Processor or Subprocessor for our customers, who are either Data Controllers or Data Processors. As such, DUOS is not liable for the provisions of GDPR that pertain to the Data Controllers. DUOS’ obligations as a Data Processor include, but are not limited to the following:
        * DUOS shall follow the instructions of the Customer in the management of their data. DUOS shall not opportunistically use or mine or use personal data that it is entrusted, aside from those mentioned elsewhere in this document or under the written instructions of the Customer.
        * DUOS shall obtain written permission from the Customer before engaging a subprocessor and assume liability for failures of the subprocessors to meet the requirements of GDPR.
        * Upon request, DUOS shall delete or return all personal data to the Customer at the end of the service contract.
        * DUOS shall enable and contribute to compliance audits conducted by the Customer’s controller or a competent representative of the controller.
        * DUOS shall take reasonable steps to secure data, such as encryption, stability and uptime, backup and disaster recovery, and regular security testing.
        * DUOS shall notify the Customer without undue delay upon learning of data breaches.
        * DUOS shall make every effort to restrict personal data transfer to a third country only if legal safeguards are obtained.
