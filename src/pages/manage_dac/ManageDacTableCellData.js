...
import {a, button, div, h, hr, span, table, thead, tr, th, tbody, td, label} from 'react-hyperscript-helpers';
import TableIconButton from '../../components/TableIconButton';
import {Styles} from '../../libs/theme';
import {Delete, Edit} from '@material-ui/icons';

export function nameCellData({name = '- -', dac, viewMembers, dacId, openViewModal, label= 'dac-name'}) {
    return {
        data: name,
        id: dacId,
        style : {
...
export function actionsCellData({dac, viewMembers, editDac, deleteDac, userRole}) {
