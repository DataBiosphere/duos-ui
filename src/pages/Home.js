          ...
          div({ className: 'row', style: { background: '#eff0f2', padding: '60px 0 72px 0' } }, [
            div({ className: 'col-lg-4 col-lg-offset-1' }, [
              ...
              a({
                ...
                button({ className: 'cell-button hover-color', style: buttonStyle }, ['REGISTER'])
            ]),
