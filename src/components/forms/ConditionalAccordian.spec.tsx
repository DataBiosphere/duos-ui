...
describe('ConditionalAccordion Component - Tests', () => {
  it('should render an accordion with children', () => {
    cy.mount(<BrowserRouter><ConditionalAccordion condition={true} title="hello world"><div><h1>Child component</h1></div></ConditionalAccordion></BrowserRouter>)
  ...
  it('condition is false, should NOT render an accordion, but still render children', () => {
    cy.mount(<BrowserRouter><ConditionalAccordion condition={false} title="hello world"><div><h1>Child component</h1></div></ConditionalAccordion></BrowserRouter>)
