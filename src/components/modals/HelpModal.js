...
export const HelpModal = hh(class HelpModal extends Component {
    ...
    render() {
        ...
        return (
            BaseModal({
                linkType: this.props.linkType, modalBtnStyle: "f-left", modalBtnIcon: "",
                id: "title_requestHelp", modalSize: "large", imgSrc: "/images/icon_add_help.png", color: "common", title: "Create a Report",
                ...
                [
                    form({ className: "form-horizontal css-form", name: "consentForm", noValidate: "true", encType: "multipart/form-data" }, [
                        div({ className: "form-group admin-form-group first-form-group" }, [
                            label({ className: "col-lg-3 col-md-3 col-sm-3 col-xs-4 control-label common-color" }, ["Subject"]),
                        ...
                        div({ className: "form-group admin-form-group" }, [
                            label({ className: "col-lg-3 col-md-3 col-sm-3 col-xs-4 control-label common-color" }, ["Description"]),
                            div({ className: "col-lg-9 col-md-9 col-sm-9 col-xs-8 admin-input" }, [
