                        ...
                        form({ name: "researcherForm", "noValidate": "true" }, [
                            ...
                            div({ isRendered: this.state.havePI === "true", className: "form-group" }, [
                                ...
                                div({ className: "col-lg-12 col-md-12 col-sm-12 col-xs-12" }, [
                                    ...
                                    input({ type: "email", className: "form-control", name: "profilePIEmail", id: "profilePIEmail", onChange: this.handleChange, value: this.state.piEmail, "ng-required": this.state.havePI === true, "ng-required": this.state.havePI === true, "ng-class": "researcherForm.profilePIEmail.$invalid && showValidationMessages ? 'form-control required-field-error' : 'form-control'" }),
