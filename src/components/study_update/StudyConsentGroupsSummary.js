...
export const StudyConsentGroupSummary = (props) => {
  const {
    formData,
  ...
  const summarizeSecondaryGroup = () => {
    const fields = findAllSetFields(formData, secondaryConsentFields);
    ...
    div({
      ...
      div({
        ...
        input({
          ...
          value: formData?.properties.datasetName,
        }),
        p({
          style: {
            fontWeight: 'bold',
...
export default StudyConsentGroupSummary;