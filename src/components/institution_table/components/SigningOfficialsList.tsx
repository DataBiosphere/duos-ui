...
export const SigningOfficialsList = ({ signingOfficials = [] }: SigningOfficialsViewProps) => {
    ...
    return (
        <div style={{paddingTop: 20, marginTop: 20, borderTop: '1px solid', borderColor: '#e1e1e1', width: '100%'}}>
            ...
            <div className={'italic'} style={{display: 'flex', alignItems: 'center', gap: '8px', paddingBottom: '2rem', width: '50%'}}>
                ...
                <div>
                    ...
                    {' '}page by assigning or removing the &#34;Signing Official&#34; role to users associated with this institution.
                </div>
            </div>
            {!hasSigningOfficials && (
