...
const schema32 = {
  ...
  "version": 1,
  "type": "object",
  "required": ["studyName", "studyDescription", "dataTypes", "dataSubmitterUserId", "publicVisibility", "nihAnvilUse", "piName", "consentGroups"],
  "allOf": [{
    ...
    "then": {"required": ["controlledAccessRequiredForGenomicSummaryResultsGSRRequiredExplanation"]}
  }, {
    "$comment": "include dbGaP related fields if they have one",
    "if": {
      "required": ["nihAnvilUse"],
      "properties": {"nihAnvilUse": {"type": "string", "enum": ["I am NHGRI funded and I have a dbGaP PHS ID already"]}}
    },
    "then": {"$ref": "#/$defs/dbGaPInfo"}
  }, {
    ...
    "if": {
      ...
      "properties": {
        "nihAnvilUse": {
          "type": "string",
          "enum": ["I am NHGRI funded and I have a dbGaP PHS ID already", "I am NHGRI funded and I do not have a dbGaP PHS ID", "I am not NHGRI funded but I am seeking to submit data to AnVIL"]
        }
      }
    },
    "then": {"$ref": "#/$defs/nihAdministrativeInformation"}
  }, {
    "$comment": "require alternative data sharing plan fields if the DS needs one",
    "if": {"required": ["alternativeDataSharingPlan"], "properties": {"alternativeDataSharingPlan": {"const": true}}},
    "then": {
      "required": ["alternativeDataSharingPlanExplanation", "alternativeDataSharingPlanReasons"],
      "properties": {"alternativeDataSharingPlanReasons": {"minItems": 1}}
    }
  }],
  "properties": {
    "studyId": {"type": "number", "label": "Study Id", "description": "The study id"},
    "studyName": {"type": "string", "label": "Study Name", "description": "The study name", "minLength": 1},
    "studyType": {
      "type": "string",
    ...
    "species": {"type": "string", "label": "Species", "description": "Species"},
    "piName": {
      "type": "string",
    ...
    "nihAnvilUse": {
      "type": "string",
      "enum": ["I am NHGRI funded and I have a dbGaP PHS ID already", "I am NHGRI funded and I do not have a dbGaP PHS ID", "I am not NHGRI funded but I am seeking to submit data to AnVIL", "I am not NHGRI funded and do not plan to store data in AnVIL"],
  ...
  "$defs": {
    "fileTypeObject": {
      ...
      "properties": {
        ...
        }, "functionalEquivalence": {"type": "string", "description": "Functional Equivalence"}
      }
    },
    "dbGaPInfo": {
      "required": ["dbGaPPhsID"],
      "properties": {
        ...
        "sequencingCenter": {"type": "string", "label": "Sequencing Center", "description": "Sequencing Center"}
      }
    },
    "nihAdministrativeInformation": {
      "required": ["piInstitution", "nihGrantContractNumber"], "properties": {
        "piInstitution": {
          "type": "integer",
        ...
        "alternativeDataSharingPlanDataSubmitted": {
          ...
          "description": "Upload your alternative sharing plan (file upload)",
          "enum": ["Within 3 months of the last data generated or last clinical visit", "By batches over Study Timeline (e.g. based on clinical trial enrollment benchmarks)"]
        },
    ...
    "consentGroup": {
      "type": "object",
      "required": ["consentGroupName", "fileTypes", "numberOfParticipants"],
      "allOf": [{
        "if": {"properties": {"dataLocation": {"const": "Not Determined"}}},
        "then": {},
        "else": {"required": ["url"]}
      }, {
        "$comment": "if openAccess is false OR not present, then require dac id & add secondary consent fields",
        "if": {"properties": {"openAccess": {"const": false}}},
        "then": {
          "required": ["dataAccessCommitteeId"], "properties": {
            "nmds": {
              "type": "boolean",
            ...
            "otherSecondary": {"type": "string", "label": "Other", "description": "Other"},
        ...
        }, {"properties": {"hmb": {"const": true}}, "required": ["hmb"]}, {
          "properties": {"poa": {"const": true}},
          "required": ["poa"]
        }, {
          "properties": {"diseaseSpecificUse": {"minItems": 1}},
          "required": ["diseaseSpecificUse"]
        }, {"properties": {"otherPrimary": {"minLength": 1}}, "required": ["otherPrimary"]}]
      }],
      "properties": {
        "datasetId": {"type": "integer", "description": "Dataset Id"},
        "datasetIdentifier": {"type": "string", "label": "Dataset Identifier", "description": "Dataset Identifier"},
        "consentGroupName": {
          "type": "string",
        ...
        "openAccess": {"type": "boolean", "label": "No Restrictions", "description": "No Restrictions"},
        "generalResearchUse": {
          "type": "boolean",
        ...
        "otherPrimary": {"type": "string", "label": "Other", "description": "Other"},
        "dataLocation": {
          "type": "string",
        ...
        "numberOfParticipants": {"type": "integer", "description": "# of Participants"},
        "fileTypes": {
          "type": "array",
          "minItems": 1,
...
const schema35 = {
  ...
  "allOf": [{
    ...
    "then": {
      "required": ["dataAccessCommitteeId"], "properties": {
        ...
        "gso": {"type": "boolean", "label": "Genetic studies only (GSO)", "description": "Genetic studies only (GSO)"},
        "pub": {"type": "boolean", "label": "Publication Required (PUB)", "description": "Publication Required (PUB)"},
        "col": {
          "type": "boolean",
          "label": "Collaboration Required (COL)",
          "description": "Collaboration Required (COL)"
        ...
        "npu": {"type": "boolean", "label": "Non-profit Use Only (NPU)", "description": "Non-profit Use Only (NPU)"},
        "otherSecondary": {"type": "string", "label": "Other", "description": "Other"},
        "dataAccessCommitteeId": {
          "type": "integer",
          "label": "Please select which DAC should govern requests for this dataset",
  ...
  "properties": {
    ...
    "openAccess": {"type": "boolean", "label": "No Restrictions", "description": "No Restrictions"},
    "generalResearchUse": {"type": "boolean", "label": "General Research Use", "description": "General Research Use"},
    "hmb": {
      "type": "boolean",
      "label": "Health/Medical/Biomedical Research Use",
      "description": "Health/Medical/Biomedical Research Use"
...
const validURLObject = (val) => { try { new URL(val); } catch (_) { return false; } return true; };
    ...
    if (data && typeof data == "object" && !Array.isArray(data)) {
      if (data.dataAccessCommitteeId === undefined) {
        const err4 = {
          ...
          keyword: "required",
          params: {missingProperty: "dataAccessCommitteeId"},
          message: "must have required property '" + "dataAccessCommitteeId" + "'"
        };
        if (vErrors === null) {
          vErrors = [err4];
        } else {
      ...
      if (data.nmds !== undefined) {
        if (typeof data.nmds !== "boolean") {
          const err5 = {
            instancePath: instancePath + "/nmds",
            schemaPath: "#/allOf/1/then/properties/nmds/type",
            keyword: "type",
            params: {type: "boolean"},
      ...
      if (data.gso !== undefined) {
        if (typeof data.gso !== "boolean") {
          const err6 = {
            instancePath: instancePath + "/gso",
            schemaPath: "#/allOf/1/then/properties/gso/type",
            keyword: "type",
            params: {type: "boolean"},
            message: "must be boolean"
          };
      ...
      if (data.pub !== undefined) {
        if (typeof data.pub !== "boolean") {
          const err7 = {
            instancePath: instancePath + "/pub",
            schemaPath: "#/allOf/1/then/properties/pub/type",
            keyword: "type",
            params: {type: "boolean"},
            message: "must be boolean"
          };
      ...
      if (data.col !== undefined) {
        if (typeof data.col !== "boolean") {
          const err8 = {
            ...
            schemaPath: "#/allOf/1/then/properties/col/type",
            keyword: "type",
            params: {type: "boolean"},
            message: "must be boolean"
          };
      ...
      if (data.irb !== undefined) {
        if (typeof data.irb !== "boolean") {
          const err9 = {
            instancePath: instancePath + "/irb",
            schemaPath: "#/allOf/1/then/properties/irb/type",
            keyword: "type",
            params: {type: "boolean"},
            message: "must be boolean"
          };
      ...
      if (data.gs !== undefined) {
        if (typeof data.gs !== "string") {
          const err10 = {
            instancePath: instancePath + "/gs",
            schemaPath: "#/allOf/1/then/properties/gs/type",
            keyword: "type",
            params: {type: "string"},
      ...
      if (data.mor !== undefined) {
        if (typeof data.mor !== "boolean") {
          const err11 = {
            instancePath: instancePath + "/mor",
            schemaPath: "#/allOf/1/then/properties/mor/type",
            keyword: "type",
            params: {type: "boolean"},
            message: "must be boolean"
          };
      ...
      if (data.morDate !== undefined) {
        ...
        if (typeof data9 === "string") {
          if (!(dateValid(data9))) {
            const err12 = {
              instancePath: instancePath + "/morDate",
              schemaPath: "#/allOf/1/then/properties/morDate/format",
              keyword: "format",
              params: {format: "date"},
          ...
          const err13 = {
            instancePath: instancePath + "/morDate",
            schemaPath: "#/allOf/1/then/properties/morDate/type",
            keyword: "type",
            params: {type: "string"},
            message: "must be string"
          };
      ...
      if (data.npu !== undefined) {
        if (typeof data.npu !== "boolean") {
          const err14 = {
            instancePath: instancePath + "/npu",
            schemaPath: "#/allOf/1/then/properties/npu/type",
            keyword: "type",
            params: {type: "boolean"},
            message: "must be boolean"
          };
      ...
      if (data.otherSecondary !== undefined) {
        if (typeof data.otherSecondary !== "string") {
          const err15 = {
            instancePath: instancePath + "/otherSecondary",
            schemaPath: "#/allOf/1/then/properties/otherSecondary/type",
            keyword: "type",
            params: {type: "string"},
            message: "must be string"
          };
      ...
      if (data.dataAccessCommitteeId !== undefined) {
        ...
        if (!((typeof data12 == "number") && (!(data12 % 1) && !isNaN(data12)))) {
          const err16 = {
            instancePath: instancePath + "/dataAccessCommitteeId",
            schemaPath: "#/allOf/1/then/properties/dataAccessCommitteeId/type",
            keyword: "type",
            params: {type: "integer"},
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.openAccess === undefined) {
      const err18 = {
        ...
        keyword: "required",
        params: {missingProperty: "openAccess"},
        message: "must have required property '" + "openAccess" + "'"
      };
      if (vErrors === null) {
        vErrors = [err18];
      } else {
    ...
    if (data.openAccess !== undefined) {
      if (true !== data.openAccess) {
        const err19 = {
          instancePath: instancePath + "/openAccess",
          schemaPath: "#/allOf/2/oneOf/0/properties/openAccess/const",
          keyword: "const",
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.generalResearchUse === undefined) {
      const err20 = {
        ...
        keyword: "required",
        params: {missingProperty: "generalResearchUse"},
        message: "must have required property '" + "generalResearchUse" + "'"
      };
      if (vErrors === null) {
        vErrors = [err20];
      } else {
    ...
    if (data.generalResearchUse !== undefined) {
      if (true !== data.generalResearchUse) {
        const err21 = {
          instancePath: instancePath + "/generalResearchUse",
          schemaPath: "#/allOf/2/oneOf/1/properties/generalResearchUse/const",
          keyword: "const",
          params: {allowedValue: true},
          message: "must be equal to constant"
        };
  ...
  if (_valid2 && valid6) {
    ...
    if (data && typeof data == "object" && !Array.isArray(data)) {
      if (data.hmb === undefined) {
        const err22 = {
          instancePath,
          schemaPath: "#/allOf/2/oneOf/2/required",
          keyword: "required",
          params: {missingProperty: "hmb"},
          message: "must have required property '" + "hmb" + "'"
        };
        if (vErrors === null) {
          vErrors = [err22];
        } else {
      ...
      if (data.hmb !== undefined) {
        if (true !== data.hmb) {
          const err23 = {
            instancePath: instancePath + "/hmb",
            schemaPath: "#/allOf/2/oneOf/2/properties/hmb/const",
            keyword: "const",
            params: {allowedValue: true},
            message: "must be equal to constant"
          };
    ...
    if (_valid2 && valid6) {
      ...
      if (data && typeof data == "object" && !Array.isArray(data)) {
        if (data.poa === undefined) {
          const err24 = {
            instancePath,
            schemaPath: "#/allOf/2/oneOf/3/required",
            keyword: "required",
            params: {missingProperty: "poa"},
            message: "must have required property '" + "poa" + "'"
          };
          if (vErrors === null) {
            vErrors = [err24];
          } else {
        ...
        if (data.poa !== undefined) {
          if (true !== data.poa) {
            const err25 = {
              instancePath: instancePath + "/poa",
              schemaPath: "#/allOf/2/oneOf/3/properties/poa/const",
              keyword: "const",
              params: {allowedValue: true},
              message: "must be equal to constant"
            };
      ...
      if (_valid2 && valid6) {
        ...
        if (data && typeof data == "object" && !Array.isArray(data)) {
          if (data.diseaseSpecificUse === undefined) {
            const err26 = {
              instancePath,
              schemaPath: "#/allOf/2/oneOf/4/required",
              keyword: "required",
              params: {missingProperty: "diseaseSpecificUse"},
              message: "must have required property '" + "diseaseSpecificUse" + "'"
            };
            if (vErrors === null) {
              vErrors = [err26];
            } else {
          ...
          if (data.diseaseSpecificUse !== undefined) {
            ...
            if (Array.isArray(data17)) {
              if (data17.length < 1) {
                const err27 = {
                  instancePath: instancePath + "/diseaseSpecificUse",
                  schemaPath: "#/allOf/2/oneOf/4/properties/diseaseSpecificUse/minItems",
                  keyword: "minItems",
                  params: {limit: 1},
        ...
        if (_valid2 && valid6) {
          ...
          if (data && typeof data == "object" && !Array.isArray(data)) {
            if (data.otherPrimary === undefined) {
              const err28 = {
                instancePath,
                schemaPath: "#/allOf/2/oneOf/5/required",
                keyword: "required",
                params: {missingProperty: "otherPrimary"},
                message: "must have required property '" + "otherPrimary" + "'"
              };
              if (vErrors === null) {
                vErrors = [err28];
              } else {
            ...
            if (data.otherPrimary !== undefined) {
              ...
              if (typeof data18 === "string") {
                if (func3(data18) < 1) {
                  const err29 = {
                    instancePath: instancePath + "/otherPrimary",
                    schemaPath: "#/allOf/2/oneOf/5/properties/otherPrimary/minLength",
                    keyword: "minLength",
                    params: {limit: 1},
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.consentGroupName === undefined) {
      const err31 = {
        ...
        schemaPath: "#/required",
        keyword: "required",
        params: {missingProperty: "consentGroupName"},
        message: "must have required property '" + "consentGroupName" + "'"
      };
      if (vErrors === null) {
        vErrors = [err31];
      } else {
    ...
    if (data.fileTypes === undefined) {
      const err32 = {
        ...
        schemaPath: "#/required",
        keyword: "required",
        params: {missingProperty: "fileTypes"},
        message: "must have required property '" + "fileTypes" + "'"
      };
      if (vErrors === null) {
        vErrors = [err32];
      } else {
    ...
    if (data.numberOfParticipants === undefined) {
      const err33 = {
        ...
        schemaPath: "#/required",
        keyword: "required",
        params: {missingProperty: "numberOfParticipants"},
        message: "must have required property '" + "numberOfParticipants" + "'"
      };
      if (vErrors === null) {
        vErrors = [err33];
      } else {
    ...
    if (data.datasetId !== undefined) {
      ...
      if (!((typeof data19 == "number") && (!(data19 % 1) && !isNaN(data19)))) {
        const err34 = {
          ...
          schemaPath: "#/properties/datasetId/type",
          keyword: "type",
          params: {type: "integer"},
          message: "must be integer"
        };
    ...
    if (data.datasetIdentifier !== undefined) {
      if (typeof data.datasetIdentifier !== "string") {
        const err35 = {
          instancePath: instancePath + "/datasetIdentifier",
          schemaPath: "#/properties/datasetIdentifier/type",
          keyword: "type",
          params: {type: "string"},
          message: "must be string"
        };
    ...
    if (data.consentGroupName !== undefined) {
      let data21 = data.consentGroupName;
      if (typeof data21 === "string") {
        if (func3(data21) < 1) {
          const err36 = {
            instancePath: instancePath + "/consentGroupName",
            schemaPath: "#/properties/consentGroupName/minLength",
            keyword: "minLength",
            params: {limit: 1},
            message: "must NOT have fewer than 1 characters"
          };
        ...
        const err37 = {
          instancePath: instancePath + "/consentGroupName",
          schemaPath: "#/properties/consentGroupName/type",
          keyword: "type",
          params: {type: "string"},
          message: "must be string"
        };
    ...
    if (data.openAccess !== undefined) {
      if (typeof data.openAccess !== "boolean") {
        const err38 = {
          instancePath: instancePath + "/openAccess",
          schemaPath: "#/properties/openAccess/type",
          keyword: "type",
          params: {type: "boolean"},
          message: "must be boolean"
        };
    ...
    if (data.generalResearchUse !== undefined) {
      if (typeof data.generalResearchUse !== "boolean") {
        const err39 = {
          instancePath: instancePath + "/generalResearchUse",
          schemaPath: "#/properties/generalResearchUse/type",
          keyword: "type",
          params: {type: "boolean"},
          message: "must be boolean"
        };
    ...
    if (data.hmb !== undefined) {
      if (typeof data.hmb !== "boolean") {
        const err40 = {
          instancePath: instancePath + "/hmb",
          schemaPath: "#/properties/hmb/type",
          keyword: "type",
          params: {type: "boolean"},
          message: "must be boolean"
        };
    ...
    if (data.diseaseSpecificUse !== undefined) {
      let data25 = data.diseaseSpecificUse;
      if (Array.isArray(data25)) {
        const len0 = data25.length;
        for (let i0 = 0; i0 < len0; i0++) {
          if (typeof data25[i0] !== "string") {
            const err41 = {
              instancePath: instancePath + "/diseaseSpecificUse/" + i0,
              schemaPath: "#/properties/diseaseSpecificUse/items/type",
              keyword: "type",
              params: {type: "string"},
              message: "must be string"
            };
        ...
        const err42 = {
          instancePath: instancePath + "/diseaseSpecificUse",
          schemaPath: "#/properties/diseaseSpecificUse/type",
          keyword: "type",
          params: {type: "array"},
    ...
    if (data.poa !== undefined) {
      if (typeof data.poa !== "boolean") {
        const err43 = {
          instancePath: instancePath + "/poa",
          schemaPath: "#/properties/poa/type",
          keyword: "type",
          params: {type: "boolean"},
          message: "must be boolean"
        };
    ...
    if (data.otherPrimary !== undefined) {
      if (typeof data.otherPrimary !== "string") {
        const err44 = {
          instancePath: instancePath + "/otherPrimary",
          schemaPath: "#/properties/otherPrimary/type",
          keyword: "type",
          params: {type: "string"},
          message: "must be string"
        };
    ...
    if (data.dataLocation !== undefined) {
      let data29 = data.dataLocation;
      if (typeof data29 !== "string") {
        const err45 = {
          instancePath: instancePath + "/dataLocation",
          schemaPath: "#/properties/dataLocation/type",
          keyword: "type",
          params: {type: "string"},
          message: "must be string"
        };
      ...
      if (!((((data29 === "AnVIL Workspace") || (data29 === "Terra Workspace")) || (data29 === "TDR Location")) || (data29 === "Not Determined"))) {
        const err46 = {
          instancePath: instancePath + "/dataLocation",
          schemaPath: "#/properties/dataLocation/enum",
          keyword: "enum",
          params: {allowedValues: schema35.properties.dataLocation.enum},
    ...
    if (data.numberOfParticipants !== undefined) {
      let data31 = data.numberOfParticipants;
      if (!((typeof data31 == "number") && (!(data31 % 1) && !isNaN(data31)))) {
        const err50 = {
          instancePath: instancePath + "/numberOfParticipants",
          schemaPath: "#/properties/numberOfParticipants/type",
          keyword: "type",
          params: {type: "integer"},
          message: "must be integer"
        };
    ...
    if (data.fileTypes !== undefined) {
      let data32 = data.fileTypes;
      if (Array.isArray(data32)) {
        if (data32.length < 1) {
          const err51 = {
            instancePath: instancePath + "/fileTypes",
            schemaPath: "#/properties/fileTypes/minItems",
            keyword: "minItems",
            params: {limit: 1},
            message: "must NOT have fewer than 1 items"
          };
        ...
        for (let i1 = 0; i1 < len1; i1++) {
          ...
          if (data33 && typeof data33 == "object" && !Array.isArray(data33)) {
            if (data33.fileType !== undefined) {
              let data34 = data33.fileType;
              if (typeof data34 !== "string") {
                const err52 = {
                  instancePath: instancePath + "/fileTypes/" + i1 + "/fileType",
                  schemaPath: "#/$defs/fileTypeObject/properties/fileType/type",
                  keyword: "type",
                  params: {type: "string"},
                  message: "must be string"
                };
              ...
              if (!(((((data34 === "Arrays") || (data34 === "Genome")) || (data34 === "Exome")) || (data34 === "Survey")) || (data34 === "Phenotype"))) {
                const err53 = {
                  instancePath: instancePath + "/fileTypes/" + i1 + "/fileType",
                  schemaPath: "#/$defs/fileTypeObject/properties/fileType/enum",
                  keyword: "enum",
                  params: {allowedValues: schema36.properties.fileType.enum},
                  message: "must be equal to one of the allowed values"
                };
                if (vErrors === null) {
                  vErrors = [err53];
            ...
            if (data33.functionalEquivalence !== undefined) {
              if (typeof data33.functionalEquivalence !== "string") {
                const err54 = {
                  instancePath: instancePath + "/fileTypes/" + i1 + "/functionalEquivalence",
                  schemaPath: "#/$defs/fileTypeObject/properties/functionalEquivalence/type",
                  keyword: "type",
                  params: {type: "string"},
                  message: "must be string"
                };
            ...
            const err55 = {
              instancePath: instancePath + "/fileTypes/" + i1,
              schemaPath: "#/$defs/fileTypeObject/type",
              keyword: "type",
              params: {type: "object"},
        ...
        const err56 = {
          instancePath: instancePath + "/fileTypes",
          schemaPath: "#/properties/fileTypes/type",
          keyword: "type",
          params: {type: "array"},
          message: "must be array"
        };
...
function validate28(data, {
  ...
  /*# sourceURL="https://consent.dsde-prod.broadinstitute.org/schemas/dataset-registration/v1" */
  ;
  let vErrors = null;
  let errors = 0;
    ...
    if (data && typeof data == "object" && !Array.isArray(data)) {
      if (data.controlledAccessRequiredForGenomicSummaryResultsGSRRequiredExplanation === undefined) {
        const err2 = {
          ...
          keyword: "required",
          params: {missingProperty: "controlledAccessRequiredForGenomicSummaryResultsGSRRequiredExplanation"},
          message: "must have required property '" + "controlledAccessRequiredForGenomicSummaryResultsGSRRequiredExplanation" + "'"
        };
        if (vErrors === null) {
          vErrors = [err2];
        } else {
  ...
  if (_valid1) {
    ...
    if (data && typeof data == "object" && !Array.isArray(data)) {
      if (data.dbGaPPhsID === undefined) {
        const err7 = {
          instancePath,
          schemaPath: "#/$defs/dbGaPInfo/required",
          keyword: "required",
          params: {missingProperty: "dbGaPPhsID"},
          message: "must have required property '" + "dbGaPPhsID" + "'"
        };
        if (vErrors === null) {
          vErrors = [err7];
        } else {
      ...
      if (data.dbGaPPhsID !== undefined) {
        ...
        if (typeof data2 === "string") {
          if (func3(data2) < 1) {
            const err8 = {
              instancePath: instancePath + "/dbGaPPhsID",
              schemaPath: "#/$defs/dbGaPInfo/properties/dbGaPPhsID/minLength",
              keyword: "minLength",
              params: {limit: 1},
              message: "must NOT have fewer than 1 characters"
            };
          ...
          const err9 = {
            instancePath: instancePath + "/dbGaPPhsID",
            schemaPath: "#/$defs/dbGaPInfo/properties/dbGaPPhsID/type",
            keyword: "type",
            params: {type: "string"},
            message: "must be string"
          };
      ...
      if (data.dbGaPStudyRegistrationName !== undefined) {
        if (typeof data.dbGaPStudyRegistrationName !== "string") {
          const err10 = {
            instancePath: instancePath + "/dbGaPStudyRegistrationName",
            schemaPath: "#/$defs/dbGaPInfo/properties/dbGaPStudyRegistrationName/type",
            keyword: "type",
            params: {type: "string"},
            message: "must be string"
          };
      ...
      if (data.embargoReleaseDate !== undefined) {
        ...
        if (typeof data4 === "string") {
          if (!(dateValid(data4))) {
            const err11 = {
              instancePath: instancePath + "/embargoReleaseDate",
              schemaPath: "#/$defs/dbGaPInfo/properties/embargoReleaseDate/format",
              keyword: "format",
              params: {format: "date"},
              message: "must match format \"" + "date" + "\""
            };
          ...
          const err12 = {
            instancePath: instancePath + "/embargoReleaseDate",
            schemaPath: "#/$defs/dbGaPInfo/properties/embargoReleaseDate/type",
            keyword: "type",
            params: {type: "string"},
            message: "must be string"
          };
      ...
      if (data.sequencingCenter !== undefined) {
        if (typeof data.sequencingCenter !== "string") {
          const err13 = {
            instancePath: instancePath + "/sequencingCenter",
            schemaPath: "#/$defs/dbGaPInfo/properties/sequencingCenter/type",
            keyword: "type",
            params: {type: "string"},
            message: "must be string"
          };
  ...
  if (_valid2) {
    ...
    if (data && typeof data == "object" && !Array.isArray(data)) {
      if (data.piInstitution === undefined) {
        const err18 = {
          instancePath,
          schemaPath: "#/$defs/nihAdministrativeInformation/required",
          keyword: "required",
          params: {missingProperty: "piInstitution"},
          message: "must have required property '" + "piInstitution" + "'"
        };
        if (vErrors === null) {
          vErrors = [err18];
        } else {
      ...
      if (data.nihGrantContractNumber === undefined) {
        const err19 = {
          ...
          schemaPath: "#/$defs/nihAdministrativeInformation/required",
          keyword: "required",
          params: {missingProperty: "nihGrantContractNumber"},
          message: "must have required property '" + "nihGrantContractNumber" + "'"
        };
        if (vErrors === null) {
          vErrors = [err19];
        } else {
      ...
      if (data.piInstitution !== undefined) {
        ...
        if (!((typeof data7 == "number") && (!(data7 % 1) && !isNaN(data7)))) {
          const err20 = {
            instancePath: instancePath + "/piInstitution",
            schemaPath: "#/$defs/nihAdministrativeInformation/properties/piInstitution/type",
            keyword: "type",
            params: {type: "integer"},
            message: "must be integer"
          };
      ...
      if (data.nihGrantContractNumber !== undefined) {
        ...
        if (typeof data8 === "string") {
          if (func3(data8) < 1) {
            const err21 = {
              instancePath: instancePath + "/nihGrantContractNumber",
              schemaPath: "#/$defs/nihAdministrativeInformation/properties/nihGrantContractNumber/minLength",
              keyword: "minLength",
              params: {limit: 1},
              message: "must NOT have fewer than 1 characters"
            };
          ...
          const err22 = {
            instancePath: instancePath + "/nihGrantContractNumber",
            schemaPath: "#/$defs/nihAdministrativeInformation/properties/nihGrantContractNumber/type",
            keyword: "type",
            params: {type: "string"},
            message: "must be string"
          };
        ...
        if (Array.isArray(data9)) {
          ...
          for (let i0 = 0; i0 < len0; i0++) {
            ...
            if (typeof data10 !== "string") {
              const err23 = {
                instancePath: instancePath + "/nihICsSupportingStudy/" + i0,
                schemaPath: "#/$defs/nihAdministrativeInformation/properties/nihICsSupportingStudy/items/type",
                keyword: "type",
                params: {type: "string"},
                message: "must be string"
              };
            ...
            if (!(((((((((((((((((((((((((((data10 === "NCI") || (data10 === "NEI")) || (data10 === "NHLBI")) || (data10 === "NHGRI")) || (data10 === "NIA")) || (data10 === "NIAAA")) || (data10 === "NIAID")) || (data10 === "NIAMS")) || (data10 === "NIBIB")) || (data10 === "NICHD")) || (data10 === "NIDCD")) || (data10 === "NIDCR")) || (data10 === "NIDDK")) || (data10 === "NIDA")) || (data10 === "NIEHS")) || (data10 === "NIGMS")) || (data10 === "NIMH")) || (data10 === "NIMHD")) || (data10 === "NINDS")) || (data10 === "NINR")) || (data10 === "NLM")) || (data10 === "CC")) || (data10 === "CIT")) || (data10 === "CSR")) || (data10 === "FIC")) || (data10 === "NCATS")) || (data10 === "NCCIH"))) {
              const err24 = {
                instancePath: instancePath + "/nihICsSupportingStudy/" + i0,
                schemaPath: "#/$defs/nihAdministrativeInformation/properties/nihICsSupportingStudy/items/enum",
                keyword: "enum",
                params: {allowedValues: schema34.properties.nihICsSupportingStudy.items.enum},
                message: "must be equal to one of the allowed values"
              };
              if (vErrors === null) {
                vErrors = [err24];
          ...
          const err25 = {
            instancePath: instancePath + "/nihICsSupportingStudy",
            schemaPath: "#/$defs/nihAdministrativeInformation/properties/nihICsSupportingStudy/type",
            keyword: "type",
            params: {type: "array"},
            message: "must be array"
          };
      ...
      if (data.nihProgramOfficerName !== undefined) {
        if (typeof data.nihProgramOfficerName !== "string") {
          const err26 = {
            instancePath: instancePath + "/nihProgramOfficerName",
            schemaPath: "#/$defs/nihAdministrativeInformation/properties/nihProgramOfficerName/type",
            keyword: "type",
            params: {type: "string"},
            message: "must be string"
          };
      ...
      if (data.nihInstitutionCenterSubmission !== undefined) {
        ...
        if (typeof data12 !== "string") {
          const err27 = {
            instancePath: instancePath + "/nihInstitutionCenterSubmission",
            schemaPath: "#/$defs/nihAdministrativeInformation/properties/nihInstitutionCenterSubmission/type",
            keyword: "type",
            params: {type: "string"},
            message: "must be string"
          };
        ...
        if (!(((((((((((((((((((((((((((data12 === "NCI") || (data12 === "NEI")) || (data12 === "NHLBI")) || (data12 === "NHGRI")) || (data12 === "NIA")) || (data12 === "NIAAA")) || (data12 === "NIAID")) || (data12 === "NIAMS")) || (data12 === "NIBIB")) || (data12 === "NICHD")) || (data12 === "NIDCD")) || (data12 === "NIDCR")) || (data12 === "NIDDK")) || (data12 === "NIDA")) || (data12 === "NIEHS")) || (data12 === "NIGMS")) || (data12 === "NIMH")) || (data12 === "NIMHD")) || (data12 === "NINDS")) || (data12 === "NINR")) || (data12 === "NLM")) || (data12 === "CC")) || (data12 === "CIT")) || (data12 === "CSR")) || (data12 === "FIC")) || (data12 === "NCATS")) || (data12 === "NCCIH"))) {
          const err28 = {
            instancePath: instancePath + "/nihInstitutionCenterSubmission",
            schemaPath: "#/$defs/nihAdministrativeInformation/properties/nihInstitutionCenterSubmission/enum",
            keyword: "enum",
            params: {allowedValues: schema34.properties.nihInstitutionCenterSubmission.enum},
            message: "must be equal to one of the allowed values"
          };
          if (vErrors === null) {
            vErrors = [err28];
      ...
      if (data.nihGenomicProgramAdministratorName !== undefined) {
        if (typeof data.nihGenomicProgramAdministratorName !== "string") {
          const err29 = {
            instancePath: instancePath + "/nihGenomicProgramAdministratorName",
            schemaPath: "#/$defs/nihAdministrativeInformation/properties/nihGenomicProgramAdministratorName/type",
            keyword: "type",
            params: {type: "string"},
            message: "must be string"
          };
      ...
      if (data.multiCenterStudy !== undefined) {
        if (typeof data.multiCenterStudy !== "boolean") {
          const err30 = {
            instancePath: instancePath + "/multiCenterStudy",
            schemaPath: "#/$defs/nihAdministrativeInformation/properties/multiCenterStudy/type",
            keyword: "type",
            params: {type: "boolean"},
            message: "must be boolean"
          };
        ...
        if (Array.isArray(data15)) {
          ...
          for (let i1 = 0; i1 < len1; i1++) {
            if (typeof data15[i1] !== "string") {
              const err31 = {
                instancePath: instancePath + "/collaboratingSites/" + i1,
                schemaPath: "#/$defs/nihAdministrativeInformation/properties/collaboratingSites/items/type",
                keyword: "type",
                params: {type: "string"},
                message: "must be string"
              };
          ...
          const err32 = {
            instancePath: instancePath + "/collaboratingSites",
            schemaPath: "#/$defs/nihAdministrativeInformation/properties/collaboratingSites/type",
            keyword: "type",
            params: {type: "array"},
            message: "must be array"
          };
      ...
      if (data.controlledAccessRequiredForGenomicSummaryResultsGSR !== undefined) {
        if (typeof data.controlledAccessRequiredForGenomicSummaryResultsGSR !== "boolean") {
          const err33 = {
            instancePath: instancePath + "/controlledAccessRequiredForGenomicSummaryResultsGSR",
            schemaPath: "#/$defs/nihAdministrativeInformation/properties/controlledAccessRequiredForGenomicSummaryResultsGSR/type",
            keyword: "type",
            params: {type: "boolean"},
            message: "must be boolean"
          };
      ...
      if (data.controlledAccessRequiredForGenomicSummaryResultsGSRRequiredExplanation !== undefined) {
        ...
        if (typeof data18 === "string") {
          if (func3(data18) < 1) {
            const err34 = {
              instancePath: instancePath + "/controlledAccessRequiredForGenomicSummaryResultsGSRRequiredExplanation",
              schemaPath: "#/$defs/nihAdministrativeInformation/properties/controlledAccessRequiredForGenomicSummaryResultsGSRRequiredExplanation/minLength",
              keyword: "minLength",
              params: {limit: 1},
              message: "must NOT have fewer than 1 characters"
            };
          ...
          const err35 = {
            instancePath: instancePath + "/controlledAccessRequiredForGenomicSummaryResultsGSRRequiredExplanation",
            schemaPath: "#/$defs/nihAdministrativeInformation/properties/controlledAccessRequiredForGenomicSummaryResultsGSRRequiredExplanation/type",
            keyword: "type",
            params: {type: "string"},
            message: "must be string"
          };
      ...
      if (data.alternativeDataSharingPlan !== undefined) {
        if (typeof data.alternativeDataSharingPlan !== "boolean") {
          const err36 = {
            instancePath: instancePath + "/alternativeDataSharingPlan",
            schemaPath: "#/$defs/nihAdministrativeInformation/properties/alternativeDataSharingPlan/type",
            keyword: "type",
            params: {type: "boolean"},
            message: "must be boolean"
          };
      ...
      if (data.alternativeDataSharingPlanReasons !== undefined) {
        ...
        if (Array.isArray(data20)) {
          ...
          for (let i2 = 0; i2 < len2; i2++) {
            ...
            if (typeof data21 !== "string") {
              const err37 = {
                instancePath: instancePath + "/alternativeDataSharingPlanReasons/" + i2,
                schemaPath: "#/$defs/nihAdministrativeInformation/properties/alternativeDataSharingPlanReasons/items/type",
                keyword: "type",
                params: {type: "string"},
                message: "must be string"
              };
            ...
            if (!((((((((data21 === "Legal Restrictions") || (data21 === "Informed consent processes are inadequate to support data for sharing for the following reasons:")) || (data21 === "The consent forms are unavailable or non-existent for samples collected after January 25, 2015")) || (data21 === "The consent process did not specifically address future use or broad data sharing for samples collected after January 25, 2015")) || (data21 === "The consent process inadequately addresses risks related to future use or broad data sharing for samples collected after January 25, 2015")) || (data21 === "The consent process specifically precludes future use or broad data sharing (including a statement that use of data will be limited to the original researchers)")) || (data21 === "Other informed consent limitations or concerns")) || (data21 === "Other"))) {
              const err38 = {
                instancePath: instancePath + "/alternativeDataSharingPlanReasons/" + i2,
                schemaPath: "#/$defs/nihAdministrativeInformation/properties/alternativeDataSharingPlanReasons/items/enum",
                keyword: "enum",
                params: {allowedValues: schema34.properties.alternativeDataSharingPlanReasons.items.enum},
                message: "must be equal to one of the allowed values"
              };
              if (vErrors === null) {
                vErrors = [err38];
          ...
          const err39 = {
            instancePath: instancePath + "/alternativeDataSharingPlanReasons",
            schemaPath: "#/$defs/nihAdministrativeInformation/properties/alternativeDataSharingPlanReasons/type",
            keyword: "type",
            params: {type: "array"},
            message: "must be array"
          };
      ...
      if (data.alternativeDataSharingPlanExplanation !== undefined) {
        if (typeof data.alternativeDataSharingPlanExplanation !== "string") {
          const err40 = {
            instancePath: instancePath + "/alternativeDataSharingPlanExplanation",
            schemaPath: "#/$defs/nihAdministrativeInformation/properties/alternativeDataSharingPlanExplanation/type",
            keyword: "type",
            params: {type: "string"},
            message: "must be string"
          };
      ...
      if (data.alternativeDataSharingPlanFileName !== undefined) {
        if (typeof data.alternativeDataSharingPlanFileName !== "string") {
          const err41 = {
            instancePath: instancePath + "/alternativeDataSharingPlanFileName",
            schemaPath: "#/$defs/nihAdministrativeInformation/properties/alternativeDataSharingPlanFileName/type",
            keyword: "type",
            params: {type: "string"},
            message: "must be string"
          };
      ...
      if (data.alternativeDataSharingPlanDataSubmitted !== undefined) {
        ...
        if (typeof data24 !== "string") {
          const err42 = {
            instancePath: instancePath + "/alternativeDataSharingPlanDataSubmitted",
            schemaPath: "#/$defs/nihAdministrativeInformation/properties/alternativeDataSharingPlanDataSubmitted/type",
            keyword: "type",
            params: {type: "string"},
            message: "must be string"
          };
        ...
        if (!((data24 === "Within 3 months of the last data generated or last clinical visit") || (data24 === "By batches over Study Timeline (e.g. based on clinical trial enrollment benchmarks)"))) {
          const err43 = {
            instancePath: instancePath + "/alternativeDataSharingPlanDataSubmitted",
            schemaPath: "#/$defs/nihAdministrativeInformation/properties/alternativeDataSharingPlanDataSubmitted/enum",
            keyword: "enum",
            params: {allowedValues: schema34.properties.alternativeDataSharingPlanDataSubmitted.enum},
            message: "must be equal to one of the allowed values"
          };
          if (vErrors === null) {
            vErrors = [err43];
      ...
      if (data.alternativeDataSharingPlanDataReleased !== undefined) {
        if (typeof data.alternativeDataSharingPlanDataReleased !== "boolean") {
          const err44 = {
            instancePath: instancePath + "/alternativeDataSharingPlanDataReleased",
            schemaPath: "#/$defs/nihAdministrativeInformation/properties/alternativeDataSharingPlanDataReleased/type",
            keyword: "type",
            params: {type: "boolean"},
            message: "must be boolean"
          };
      ...
      if (data.alternativeDataSharingPlanTargetDeliveryDate !== undefined) {
        ...
        if (typeof data26 === "string") {
          if (!(dateValid(data26))) {
            const err45 = {
              instancePath: instancePath + "/alternativeDataSharingPlanTargetDeliveryDate",
              schemaPath: "#/$defs/nihAdministrativeInformation/properties/alternativeDataSharingPlanTargetDeliveryDate/format",
              keyword: "format",
              params: {format: "date"},
              message: "must match format \"" + "date" + "\""
            };
          ...
          const err46 = {
            instancePath: instancePath + "/alternativeDataSharingPlanTargetDeliveryDate",
            schemaPath: "#/$defs/nihAdministrativeInformation/properties/alternativeDataSharingPlanTargetDeliveryDate/type",
            keyword: "type",
            params: {type: "string"},
            message: "must be string"
          };
      ...
      if (data.alternativeDataSharingPlanControlledOpenAccess !== undefined) {
        ...
        if (typeof data27 !== "string") {
          const err47 = {
            ...
            schemaPath: "#/$defs/nihAdministrativeInformation/properties/alternativeDataSharingPlanControlledOpenAccess/type",
            keyword: "type",
            params: {type: "string"},
            message: "must be string"
          };
        ...
        if (!((data27 === "Controlled Access") || (data27 === "Open Access"))) {
          const err48 = {
            instancePath: instancePath + "/alternativeDataSharingPlanControlledOpenAccess",
            schemaPath: "#/$defs/nihAdministrativeInformation/properties/alternativeDataSharingPlanControlledOpenAccess/enum",
            keyword: "enum",
            params: {allowedValues: schema34.properties.alternativeDataSharingPlanControlledOpenAccess.enum},
            message: "must be equal to one of the allowed values"
          };
          if (vErrors === null) {
            vErrors = [err48];
    ...
    if (data && typeof data == "object" && !Array.isArray(data)) {
      if (data.alternativeDataSharingPlanExplanation === undefined) {
        const err52 = {
          ...
          keyword: "required",
          params: {missingProperty: "alternativeDataSharingPlanExplanation"},
          message: "must have required property '" + "alternativeDataSharingPlanExplanation" + "'"
        };
        if (vErrors === null) {
          vErrors = [err52];
        } else {
      ...
      if (data.alternativeDataSharingPlanReasons === undefined) {
        const err53 = {
          ...
          schemaPath: "#/allOf/3/then/required",
          keyword: "required",
          params: {missingProperty: "alternativeDataSharingPlanReasons"},
          message: "must have required property '" + "alternativeDataSharingPlanReasons" + "'"
        };
        if (vErrors === null) {
          vErrors = [err53];
        } else {
      ...
      if (data.alternativeDataSharingPlanReasons !== undefined) {
        ...
        if (Array.isArray(data29)) {
          if (data29.length < 1) {
            const err54 = {
              instancePath: instancePath + "/alternativeDataSharingPlanReasons",
              schemaPath: "#/allOf/3/then/properties/alternativeDataSharingPlanReasons/minItems",
              keyword: "minItems",
              params: {limit: 1},
              message: "must NOT have fewer than 1 items"
            };
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.studyName === undefined) {
      const err56 = {
        ...
        schemaPath: "#/required",
        keyword: "required",
        params: {missingProperty: "studyName"},
        message: "must have required property '" + "studyName" + "'"
      };
      if (vErrors === null) {
        vErrors = [err56];
      } else {
    ...
    if (data.studyDescription === undefined) {
      const err57 = {
        ...
        schemaPath: "#/required",
        keyword: "required",
        params: {missingProperty: "studyDescription"},
        message: "must have required property '" + "studyDescription" + "'"
      };
      if (vErrors === null) {
        vErrors = [err57];
      } else {
    ...
    if (data.dataTypes === undefined) {
      const err58 = {
        ...
        schemaPath: "#/required",
        keyword: "required",
        params: {missingProperty: "dataTypes"},
        message: "must have required property '" + "dataTypes" + "'"
      };
      if (vErrors === null) {
        vErrors = [err58];
      } else {
    ...
    if (data.dataSubmitterUserId === undefined) {
      const err59 = {
        ...
        schemaPath: "#/required",
        keyword: "required",
        params: {missingProperty: "dataSubmitterUserId"},
        message: "must have required property '" + "dataSubmitterUserId" + "'"
      };
      if (vErrors === null) {
        vErrors = [err59];
      } else {
    ...
    if (data.publicVisibility === undefined) {
      const err60 = {
        ...
        schemaPath: "#/required",
        keyword: "required",
        params: {missingProperty: "publicVisibility"},
        message: "must have required property '" + "publicVisibility" + "'"
      };
      if (vErrors === null) {
        vErrors = [err60];
      } else {
    ...
    if (data.nihAnvilUse === undefined) {
      const err61 = {
        ...
        schemaPath: "#/required",
        keyword: "required",
        params: {missingProperty: "nihAnvilUse"},
        message: "must have required property '" + "nihAnvilUse" + "'"
      };
      if (vErrors === null) {
        vErrors = [err61];
      } else {
    ...
    if (data.piName === undefined) {
      const err62 = {
        ...
        schemaPath: "#/required",
        keyword: "required",
        params: {missingProperty: "piName"},
        message: "must have required property '" + "piName" + "'"
      };
      if (vErrors === null) {
        vErrors = [err62];
      } else {
    ...
    if (data.consentGroups === undefined) {
      const err63 = {
        ...
        schemaPath: "#/required",
        keyword: "required",
        params: {missingProperty: "consentGroups"},
        message: "must have required property '" + "consentGroups" + "'"
      };
      if (vErrors === null) {
        vErrors = [err63];
      } else {
    ...
    if (data.studyId !== undefined) {
      if (!(typeof data.studyId == "number")) {
        const err64 = {
          instancePath: instancePath + "/studyId",
          schemaPath: "#/properties/studyId/type",
          keyword: "type",
          params: {type: "number"},
    ...
    if (data.studyName !== undefined) {
      let data31 = data.studyName;
      if (typeof data31 === "string") {
        if (func3(data31) < 1) {
          const err65 = {
            instancePath: instancePath + "/studyName",
            schemaPath: "#/properties/studyName/minLength",
            keyword: "minLength",
            params: {limit: 1},
            message: "must NOT have fewer than 1 characters"
          };
        ...
        const err66 = {
          instancePath: instancePath + "/studyName",
          schemaPath: "#/properties/studyName/type",
          keyword: "type",
          params: {type: "string"},
          message: "must be string"
        };
    ...
    if (data.studyType !== undefined) {
      let data32 = data.studyType;
      if (typeof data32 !== "string") {
        const err67 = {
          instancePath: instancePath + "/studyType",
          schemaPath: "#/properties/studyType/type",
          keyword: "type",
          params: {type: "string"},
          message: "must be string"
        };
      ...
      if (!((((((((((data32 === "Observational") || (data32 === "Interventional")) || (data32 === "Descriptive")) || (data32 === "Analytical")) || (data32 === "Prospective")) || (data32 === "Retrospective")) || (data32 === "Case report")) || (data32 === "Case series")) || (data32 === "Cross-sectional")) || (data32 === "Cohort study"))) {
        const err68 = {
          instancePath: instancePath + "/studyType",
          schemaPath: "#/properties/studyType/enum",
          keyword: "enum",
          params: {allowedValues: schema32.properties.studyType.enum},
          message: "must be equal to one of the allowed values"
        };
        if (vErrors === null) {
          vErrors = [err68];
    ...
    if (data.studyDescription !== undefined) {
      let data33 = data.studyDescription;
      if (typeof data33 === "string") {
        if (func3(data33) < 1) {
          const err69 = {
            instancePath: instancePath + "/studyDescription",
            schemaPath: "#/properties/studyDescription/minLength",
            keyword: "minLength",
            params: {limit: 1},
            message: "must NOT have fewer than 1 characters"
          };
        ...
        const err70 = {
          instancePath: instancePath + "/studyDescription",
          schemaPath: "#/properties/studyDescription/type",
          keyword: "type",
          params: {type: "string"},
          message: "must be string"
        };
    ...
    if (data.dataTypes !== undefined) {
      let data34 = data.dataTypes;
      if (Array.isArray(data34)) {
        if (data34.length < 1) {
          const err71 = {
            instancePath: instancePath + "/dataTypes",
            schemaPath: "#/properties/dataTypes/minItems",
            keyword: "minItems",
            params: {limit: 1},
            message: "must NOT have fewer than 1 items"
          };
        ...
        for (let i3 = 0; i3 < len3; i3++) {
          if (typeof data34[i3] !== "string") {
            const err72 = {
              instancePath: instancePath + "/dataTypes/" + i3,
              schemaPath: "#/properties/dataTypes/items/type",
              keyword: "type",
              params: {type: "string"},
              message: "must be string"
            };
        ...
        const err73 = {
          instancePath: instancePath + "/dataTypes",
          schemaPath: "#/properties/dataTypes/type",
          keyword: "type",
          params: {type: "array"},
          message: "must be array"
        };
    ...
    if (data.phenotypeIndication !== undefined) {
      if (typeof data.phenotypeIndication !== "string") {
        const err74 = {
          instancePath: instancePath + "/phenotypeIndication",
          schemaPath: "#/properties/phenotypeIndication/type",
          keyword: "type",
          params: {type: "string"},
          message: "must be string"
        };
    ...
    if (data.piName !== undefined) {
      let data38 = data.piName;
      if (typeof data38 === "string") {
        if (func3(data38) < 1) {
          const err76 = {
            instancePath: instancePath + "/piName",
            schemaPath: "#/properties/piName/minLength",
            keyword: "minLength",
            params: {limit: 1},
            message: "must NOT have fewer than 1 characters"
          };
        ...
        const err77 = {
          instancePath: instancePath + "/piName",
          schemaPath: "#/properties/piName/type",
          keyword: "type",
          params: {type: "string"},
          message: "must be string"
        };
    ...
    if (data.dataSubmitterUserId !== undefined) {
      let data39 = data.dataSubmitterUserId;
      if (!((typeof data39 == "number") && (!(data39 % 1) && !isNaN(data39)))) {
        const err78 = {
          instancePath: instancePath + "/dataSubmitterUserId",
          schemaPath: "#/properties/dataSubmitterUserId/type",
          keyword: "type",
          params: {type: "integer"},
          message: "must be integer"
        };
    ...
    if (data.dataCustodianEmail !== undefined) {
      let data40 = data.dataCustodianEmail;
      if (Array.isArray(data40)) {
        const len4 = data40.length;
        for (let i4 = 0; i4 < len4; i4++) {
          let data41 = data40[i4];
          if (typeof data41 === "string") {
            if (!(formats4.test(data41))) {
              const err79 = {
                instancePath: instancePath + "/dataCustodianEmail/" + i4,
                schemaPath: "#/properties/dataCustodianEmail/items/format",
                keyword: "format",
                params: {format: "email"},
            ...
            const err80 = {
              instancePath: instancePath + "/dataCustodianEmail/" + i4,
              schemaPath: "#/properties/dataCustodianEmail/items/type",
              keyword: "type",
              params: {type: "string"},
              message: "must be string"
            };
        ...
        const err81 = {
          instancePath: instancePath + "/dataCustodianEmail",
          schemaPath: "#/properties/dataCustodianEmail/type",
          keyword: "type",
          params: {type: "array"},
          message: "must be array"
        };
    ...
    if (data.publicVisibility !== undefined) {
      if (typeof data.publicVisibility !== "boolean") {
        const err82 = {
          instancePath: instancePath + "/publicVisibility",
          schemaPath: "#/properties/publicVisibility/type",
          keyword: "type",
          params: {type: "boolean"},
          message: "must be boolean"
        };
    ...
    if (data.nihAnvilUse !== undefined) {
      let data43 = data.nihAnvilUse;
      if (typeof data43 !== "string") {
        const err83 = {
          instancePath: instancePath + "/nihAnvilUse",
          schemaPath: "#/properties/nihAnvilUse/type",
          keyword: "type",
          params: {type: "string"},
          message: "must be string"
        };
      ...
      if (!((((data43 === "I am NHGRI funded and I have a dbGaP PHS ID already") || (data43 === "I am NHGRI funded and I do not have a dbGaP PHS ID")) || (data43 === "I am not NHGRI funded but I am seeking to submit data to AnVIL")) || (data43 === "I am not NHGRI funded and do not plan to store data in AnVIL"))) {
        const err84 = {
          instancePath: instancePath + "/nihAnvilUse",
          schemaPath: "#/properties/nihAnvilUse/enum",
          keyword: "enum",
          params: {allowedValues: schema32.properties.nihAnvilUse.enum},
          message: "must be equal to one of the allowed values"
        };
        if (vErrors === null) {
          vErrors = [err84];
    ...
    if (data.targetDeliveryDate !== undefined) {
      let data44 = data.targetDeliveryDate;
      if (typeof data44 === "string") {
        if (!(dateValid(data44))) {
          const err85 = {
            instancePath: instancePath + "/targetDeliveryDate",
            schemaPath: "#/properties/targetDeliveryDate/format",
            keyword: "format",
            params: {format: "date"},
            message: "must match format \"" + "date" + "\""
          };
        ...
        const err86 = {
          instancePath: instancePath + "/targetDeliveryDate",
          schemaPath: "#/properties/targetDeliveryDate/type",
          keyword: "type",
          params: {type: "string"},
          message: "must be string"
        };
    ...
    if (data.targetPublicReleaseDate !== undefined) {
      let data45 = data.targetPublicReleaseDate;
      if (typeof data45 === "string") {
        if (!(dateValid(data45))) {
          const err87 = {
            instancePath: instancePath + "/targetPublicReleaseDate",
            schemaPath: "#/properties/targetPublicReleaseDate/format",
            keyword: "format",
            params: {format: "date"},
            message: "must match format \"" + "date" + "\""
          };
        ...
        const err88 = {
          instancePath: instancePath + "/targetPublicReleaseDate",
          schemaPath: "#/properties/targetPublicReleaseDate/type",
          keyword: "type",
          params: {type: "string"},
          message: "must be string"
        };
    ...
    if (data.consentGroups !== undefined) {
      let data46 = data.consentGroups;
      if (Array.isArray(data46)) {
        if (data46.length < 1) {
          const err89 = {
            instancePath: instancePath + "/consentGroups",
            schemaPath: "#/properties/consentGroups/minItems",
            keyword: "minItems",
            params: {limit: 1},
            message: "must NOT have fewer than 1 items"
          };
        ...
        for (let i5 = 0; i5 < len5; i5++) {
          if (!(validate29(data46[i5], {
            instancePath: instancePath + "/consentGroups/" + i5,
            parentData: data46,
        ...
        const err90 = {
          instancePath: instancePath + "/consentGroups",
          schemaPath: "#/properties/consentGroups/type",
          keyword: "type",
          params: {type: "array"},
          message: "must be array"
        };
