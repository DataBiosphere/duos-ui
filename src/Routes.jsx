...
const Routes = (props) => (
  <Switch>
    ...
    <AuthenticatedRoute path='/dar_application/:dataRequestId' component={DataAccessRequestApplication} props={Object.assign({}, props, {draftDar: true})}
      rolesAllowed={[USER_ROLES.researcher]} />
    <AuthenticatedRoute path='/dar_application' component={DataAccessRequestApplication} props={props} rolesAllowed={[USER_ROLES.researcher]} requiresLibraryCard={true} />
