...
const Routes = props => (
  <Switch>
    ...
    <AuthenticatedRoute path="/data_submission_form2/:studyId?" component={DataSubmissionFormV2} props={props} rolesAllowed={[USER_ROLES.admin, USER_ROLES.chairperson, USER_ROLES.dataSubmitter]} />
