...
import SigningOfficialResearchers2 from './pages/signing_official_console/SigningOfficialResearchers2';
...
const Routes = (props) => (
  <Switch>
    ...
    {checkEnv(envGroups.DEV) && <AuthenticatedRoute path="/signing_official_console/researchers_daa_associations" component={ensureSoHasDaaAcknowledgement(SigningOfficialResearchers2, true)} props={props} rolesAllowed={[USER_ROLES.admin, USER_ROLES.signingOfficial]} />}
