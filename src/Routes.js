...
import DataSubmitterConsole from './pages/data_submitter_console/DataSubmitterConsole';
...
const Routes = (props) => (
  <Switch>
    ...
    <AuthenticatedRoute path="/data_submitter_console" component={DataSubmitterConsole} props={props} rolesAllowed={[USER_ROLES.dataSubmitter]}/>
