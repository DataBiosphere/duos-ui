...
> [plans/BFF_Overview.md](plans/BFF_Overview.md). Deployments run the flow
> their `config.json` `bffEnabled` flag selects; the legacy flow below is
> removed in BFF Phase 6.
