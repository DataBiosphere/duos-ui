...
describe('ProgressReportApplication - Component Tests', () => {
  ...
  it('defaults presentationsYesNo to false when dar.presentations is undefined or empty', () => {
    // Test with undefined presentations
  ...
  it('defaults presentationsYesNo to false when dar.presentations is empty array', () => {
    // Test with empty presentations array
  ...
  it('sets presentationsYesNo to true when dar.presentations has items', () => {
    // Test with presentations array containing items
  ...
  it('defaults closeoutYesNo to false when dar.closeoutSupplement is empty string', () => {
    // Test with empty string closeoutSupplement
    const darWithEmptyCloseout = {
      closeoutSupplement: ''
    };

    mountComponent(darWithEmptyCloseout, true);
  ...
  it('sets closeoutYesNo to true when dar.closeoutSupplement has a value', () => {
    // Test with closeoutSupplement containing text
    const darWithCloseout = {
      closeoutSupplement: 'Some closeout supplement information'
    };
