...
describe('ElectionWithMemberVotesTable Component Tests', () => {
  const electionWithMemberVotes1: ElectionWithMemberVotes = {
    ...
    finalVote: false,
    status: 'In Progress',
    createDate: Date.parse('2023-02-01T10:30:00-05:00').toString(),
    ...
    memberVotes: [
      {
        ...
        updateDate: Date.parse('2023-02-03T10:30:00-05:00').toString(),
      ...
      },
      {
        ...
        updateDate: Date.parse('2023-02-04T10:30:00-05:00').toString(),
        isReminderSent: true,
        hasConcerns: true,
      },
    ],
  ...
  const electionWithMemberVotes2: ElectionWithMemberVotes = {
    ...
    finalVote: true,
    status: 'Closed',
    createDate: Date.parse('2023-01-15T10:30:00-05:00').toString(),
    ...
    memberVotes: [
      {
        ...
        updateDate: Date.parse('2023-01-18T10:30:00-05:00').toString(),
        isReminderSent: false,
        hasConcerns: false,
      },
      {
  ...
  const electionWithMemberVotes3: ElectionWithMemberVotes = {
    ...
    finalVote: false,
    status: 'In Progress',
    createDate: Date.parse('2023-03-10T10:30:00-05:00').toString(),
